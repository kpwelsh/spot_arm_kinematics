...
static struct PyModuleDef spot_arm_kinematicsmodule = {
...
PyMODINIT_FUNC PyInit_spot_arm_kinematics(void)
{
  PyObject *module = PyModule_Create(&spot_arm_kinematicsmodule);
  return module;
}
